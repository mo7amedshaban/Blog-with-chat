...
@section('content')
 ...
 <div class="container intro-container">
    ...
    <div class="row">
      ...
      <!-- PostResource Content Column -->
      <div class="col-lg-8">

        <!-- Title -->
        <h1 class="mt-4">PostResource Title</h1>
        ...
        <!-- Date/Time -->
        <p>PostResourceed on <strong class="badge badge-primary p-1">January 1, 2019</strong> at <strong class="badge badge-danger p-1"> 12:00 PM</strong>
